...
class PBAInterface implements LoggerAwareInterface
{
    ...
    public function getSubscriptionDetails(array $params = array())
    {
        $min_cnt = 1;
        $this->checkCnt($params, $min_cnt);
        $request = array(
            'Server' => 'BM',
            'Method' => 'SubscriptionDetailsGet_API',
            'Lang' => $this->lang,
            'Params' => $params,
        );
        return $this->xml_client->Execute($request);
    ...
    public function getSubscriptionValue(array $params = array())
    {
        ...
        $request = array(
            'Server' => 'BM',
            'Method' => 'SubscrParamValueGet_API',
            'Lang' => $this->lang,
            'Params' => $params,
        );
        return $this->xml_client->Execute($request);
    ...
    public function getCustomerSubscriptionList(array $params = array())
    {
        $min_cnt = 1;
        $this->checkCnt($params, $min_cnt);
        $request = array(
            'Server' => 'BM',
            'Method' => 'GetCustomerSubscriptionList_API',
            'Lang' => $this->lang,
            'Params' => $params,
        );
        return $this->xml_client->Execute($request);
